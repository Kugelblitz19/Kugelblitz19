...
```ts
const kunal = {
  role: "Product Manager × Full-Stack AI Builder",
  base: "Noida, India 🇮🇳",
  building: "AI-native LMS — interactive STEM labs for grades 1–10",
  pastLife: "3.9 yrs shipping Java + Spring Boot microservices at scale",
  nowDoing: "Specs → backend → frontend → DB, all of it, AI in the loop",
  philosophy: "Pick the right tool for the job, then ship it",
  funFact: "Reliably sarcastic 😏",
};
```

- 🔭 I turn product ideas into **working products end-to-end** — from API design and data models to the UI users actually click.
- 🤖 I build **AI-native learning experiences**: LMS labs, generative tooling, and assistants powered by LLMs.
- 🧰 Backend is home turf (**Java, Spring Boot, Microservices**), but I'll happily live in **Next.js, TypeScript & Python** to ship the whole thing.
- ✍️ I write about engineering & AI on [Medium](https://medium.com/@kunal123priya).
...
![LLMs](https://img.shields.io/badge/LLMs_%26_GenAI-412991?style=for-the-badge&logo=openai&logoColor=white)
